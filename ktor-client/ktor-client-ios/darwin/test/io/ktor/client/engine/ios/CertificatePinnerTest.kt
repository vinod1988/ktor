...
import io.ktor.client.engine.ios.certificates.*
import io.ktor.client.engine.ios.certificates.CertificatePinner.Companion.ecDsaSecp256r1Asn1HeaderInts
import io.ktor.client.engine.ios.certificates.CertificatePinner.Companion.ecDsaSecp384r1Asn1HeaderInts
import io.ktor.client.engine.ios.certificates.CertificatePinner.Companion.rsa1024Asn1HeaderInts
import io.ktor.client.engine.ios.certificates.CertificatePinner.Companion.rsa2048Asn1HeaderInts
import io.ktor.client.engine.ios.certificates.CertificatePinner.Companion.rsa3072Asn1HeaderInts
import io.ktor.client.engine.ios.certificates.CertificatePinner.Companion.rsa4096Asn1HeaderInts
...
class CertificatePinnerTest {
    ...
    fun pinsNoMatches__findMatchingPins__empty() {
        // GIVEN
        val pin1 = CertificatePinner.PinnedCertificate(
            pattern = "example.com", hashAlgorithm = "sha256/", hash = "AAA="
        )
        val pin2 = CertificatePinner.PinnedCertificate(
            pattern = "other.co.uk", hashAlgorithm = "sha256/", hash = "BBB="
        )
        val pin3 = CertificatePinner.PinnedCertificate(
            pattern = "other.co.uk", hashAlgorithm = "sha256/", hash = "CCC="
        )
        val pin4 = CertificatePinner.PinnedCertificate(
            pattern = "*.other.co.uk", hashAlgorithm = "sha1/", hash = "DDD="
        )
        val pin5 = CertificatePinner.PinnedCertificate(
        ...
        val certificatePinner =
            CertificatePinner(pins.toSet(), true)
    ...
    fun rsa1024__checkValidKeyType__true() {
        ...
        // WHEN
        val certificatePinner =
            CertificatePinner(emptySet(), true)
    ...
    fun pin_hostNoMatch__matches__false() {
        // GIVEN
        val pin = CertificatePinner.PinnedCertificate(
            pattern = "example.com", hashAlgorithm = "sha256/", hash = "AAA="
        )
        val host = "other.com"
