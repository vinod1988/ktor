...
kotlin.sourceSets {
    ...
    jvmTest {
        dependencies {
            ...
            implementation(project(":ktor-client:ktor-client-features:ktor-client-json:ktor-client-jackson"))
            implementation(project(":ktor-client:ktor-client-features:ktor-client-encoding"))
