 ...
 */
public fun Memory.Companion.of(
    buffer: ArrayBuffer, offset: Int = 0, length: Int = buffer.byteLength - offset
): Memory = Memory(DataView(buffer, offset, length))

/**
 * Create [Memory] view for the specified [view].
 */
public fun Memory.Companion.of(view: DataView): Memory = Memory(view)
...
public fun Memory.Companion.of(view: ArrayBufferView, offset: Int = 0, length: Int = view.byteLength): Memory =
    Memory.of(view.buffer, view.byteOffset + offset, length)
