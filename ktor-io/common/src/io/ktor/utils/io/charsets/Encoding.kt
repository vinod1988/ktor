...
@ExperimentalIoApi
public fun CharsetDecoder.decode(
    input: Input, max: Int = Int.MAX_VALUE
): String = buildString(minOf(max.toLong(), input.sizeEstimate()).toInt()) {
...
public expect class MalformedInputException(message: String) : Throwable
