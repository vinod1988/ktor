...
public class ByteReadPacket internal constructor(
...
) : AbstractInput(head, remaining, pool), Input {
    ...
    final override fun fill(destination: Memory, offset: Int, length: Int): Int = 0

    final override fun closeSource() {
    }

    override fun toString(): String = "ByteReadPacket($remaining bytes remaining)"
