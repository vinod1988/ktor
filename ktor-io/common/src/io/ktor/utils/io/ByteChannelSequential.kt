...
public abstract class ByteChannelSequentialBase(
    ...
    private inline fun totalPending(): Int = readable.remaining.toInt() + writable.size + flushBuffer.size

    override val availableForRead: Int
        get() = readable.remaining.toInt() + flushBuffer.size
    ...
    final override var totalBytesRead: Long by shared(0L)
        private set

    final override var totalBytesWritten: Long by shared(0L)
        private set
